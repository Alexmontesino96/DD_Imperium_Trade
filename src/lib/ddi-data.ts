...
export const copy = {
  es: {
    ...
    hero: {
      ...
      lead: "Tú vendes.",
      emph: "Nosotros abastecemos, preparamos y enviamos.",
      sub: "Distribuidora que conecta marcas con <b>Amazon y Walmart</b>, a nivel nacional e internacional — con preparación y envío desde nuestro <b>Prep Center propio</b>.",
      note: "Acceso al catálogo para vendedores · Atención directa",
    },
    cred: {
  ...
  en: {
    ...
    hero: {
      ...
      lead: "You sell.",
      emph: "We source, prep, and ship.",
      sub: "A distributor connecting brands with <b>Amazon and Walmart</b>, nationally and internationally — with prep and shipping from our <b>own Prep Center</b>.",
      note: "Catalog access for sellers · Direct support",
    },
    cred: {
